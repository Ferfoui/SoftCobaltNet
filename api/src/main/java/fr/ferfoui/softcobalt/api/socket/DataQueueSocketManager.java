...
/**
 * An abstract class used to manage the socket connection to read data from the
 * socket and put it in a queue. The queue is used to wait for data to be
 * available.
 */
public abstract class DataQueueSocketManager {
  ...
  /**
   * This method should be implemented by the subclasses to get the logger to
   * use.
   *
  ...
  /**
   * Get the queue handler runnable, it will read the data from the socket and
   * put it in the queue. The queue is used to wait for data to be available.
   *
