...
public class ApiConstants {
  ...
  public static class RequestFormatConstants {
    ...
    public static final String HEADER_PREFIX =
        "start_header" + REQUEST_SUB_SPLITTER;
    public static final String HEADER_SUFFIX =
        REQUEST_SUB_SPLITTER + "end_header";
    public static final int HEADER_PREFIX_SUFFIX_SIZE =
        HEADER_PREFIX.length() + HEADER_SUFFIX.length();

    public static final String PUBLIC_KEY_PREFIX =
        "public_key" + REQUEST_SUB_SPLITTER;
    public static final String PUBLIC_KEY_SUFFIX =
        REQUEST_SUB_SPLITTER + "end_public_key";
