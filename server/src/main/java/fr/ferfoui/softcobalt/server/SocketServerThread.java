...
public class SocketServerThread extends Thread {
  ...
  SocketServerThread() {
    ...
    serverSocketManager =
        new ServerSocketManager("server-socket", StringProcessServer::new);
  }
  ...
  private class StringProcessServer extends ClientConnection {
    ...
    public void processRequest(byte[] availableData, Logger logger) {
      ...
      try {
        ...
        requestString =
            new String(request.body(),
                       ApiConstants.RequestFormatConstants.DEFAULT_CHARSET);
      ...
      doContinueListening =
          requestString != null && !requestString.contains("exit");
    }
